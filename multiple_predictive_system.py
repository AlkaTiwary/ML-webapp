...
if (selected=="HEART DISEASE PREDICTION"):
    ...
    if st.button('Heart Disease Test Result'):
       heart_prediction = heart_disease_model([age,sex,cp,trestbps,chol,fbs,restecg,thalach,exang,oldpeak,slope,ca,thal])
       
       if (heart_prediction[0] == 0):
         h_diagnosis= 'The person is not diabetic'
       else:
         h_diagnosis= 'The person is diabetic'
